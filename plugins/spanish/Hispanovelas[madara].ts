...
const plugin = new MadaraPlugin({"id":"hispanovelas","sourceSite":"https://hispanovelas.com/","sourceName":"Hispanovelas","options":{"useNewChapterEndpoint":true,"lang":"Spanish"}});
