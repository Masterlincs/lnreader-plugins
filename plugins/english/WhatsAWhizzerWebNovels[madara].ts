...
const plugin = new MadaraPlugin({"id":"whizzerwebnovels","sourceSite":"https://whatsawhizzerwebnovels.com/","sourceName":"What's A Whizzer Web Novels","options":{"useNewChapterEndpoint":true}});
